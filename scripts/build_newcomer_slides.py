...
<head>
  ...
  <style>
    :root {
      ...
      --font-sans: ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI Variable Text", "Segoe UI", Roboto, "Noto Sans", "Helvetica Neue", Arial, sans-serif;
    }
    * { box-sizing: border-box; }
    ...
    h1 { max-width: 1050px; font-size: clamp(42px, 5.2vw, 72px); line-height: 1.04; letter-spacing: -.028em; }
    h2 { margin-bottom: 24px; font-size: clamp(31px, 3.7vw, 52px); line-height: 1.08; letter-spacing: -.02em; }
    h3 { margin-bottom: 10px; font-size: clamp(18px, 1.75vw, 25px); line-height: 1.22; letter-spacing: -.01em; }
    p, li { font-size: clamp(16px, 1.25vw, 20px); line-height: 1.5; text-wrap: pretty; }
    .lead { max-width: 980px; color: var(--muted); font-size: clamp(21px, 2.2vw, 32px); line-height: 1.4; }
    .eyebrow { margin-bottom: 20px; color: var(--orange); font-size: 13px; font-weight: 700; letter-spacing: .08em; text-transform: uppercase; }
    .big-number { color: var(--blue); font-size: clamp(68px, 10vw, 138px); font-weight: 800; letter-spacing: -.04em; line-height: .9; }
    ...
    .paper-heading { max-width: 1320px; margin-bottom: 12px; font-size: clamp(27px, 3vw, 44px); }
