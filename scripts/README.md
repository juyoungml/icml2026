...
The public course is generated by `build_learning_site.py`. Its hand-authored
teaching material lives in `learning_content.py`; shared paper and area evidence
comes from the existing slide catalog and processed briefing tables.
